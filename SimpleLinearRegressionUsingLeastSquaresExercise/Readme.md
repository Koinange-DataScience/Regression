...
##Project Overview:
In this project we simply look at exercises or rather questions to evaluate the fit of the model, and make predictions.

##Data
The exercises were simply to test the how far knowledge has been gained so there were arrays given to be worked on instead of full datasets
